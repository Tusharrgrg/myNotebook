    ...
    <>
      <div className="row my-5">
        ...
        <div className="col-md-5">
          <h1 className="display-1 pt-5 ps-auto respo"><span style={{ color: "#F94A29" }}>my</span>Notebook</h1>
          ...
          <div className='mx-4'>
            <Link className="btn mx-4" style={{ textTransform: "none", fontFamily: "'Poppins', sans-serif", background: "#F94A29" }} to = {localStorage.getItem('token') ? "/addnote" : "/login"}  role="button">Create a New Note</Link>
          </div>
        </div>
      </div>
